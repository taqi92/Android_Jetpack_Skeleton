...
class ItemDataSource : PageKeyedDataSource<Int, Movie>() {
    ...
    override fun loadInitial(
        ...
        val call: Call<PagedMovieList<Movie>> = api.getNewReleased(GlobalValues.apiKey, FIRST_PAGE)
    ...
    override fun loadAfter(params: LoadParams<Int?>, callback: LoadCallback<Int?, Movie?>) {
        val call: Call<PagedMovieList<Movie>> = api.getNewReleased(GlobalValues.apiKey, params.key)
        call.enqueue(object : Callback<PagedMovieList<Movie>> {
            override fun onResponse(
                call: Call<PagedMovieList<Movie>>,
                response: Response<PagedMovieList<Movie>>
