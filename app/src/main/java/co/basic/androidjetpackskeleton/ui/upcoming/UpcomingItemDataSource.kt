...
class UpcomingItemDataSource : PageKeyedDataSource<Int, Movie>() {


    private val TAG = "UpcomingItemDataSource"
    ...
    override fun loadInitial(
        ...
        val call: Call<PagedMovieList<Movie>> = api.getUpcoming(
            GlobalValues.apiKey,
            FIRST_PAGE
        )
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Movie>) {
        ...
        val call: Call<PagedMovieList<Movie>> = api.getUpcoming(GlobalValues.apiKey, params.key)
        call.enqueue(object : Callback<PagedMovieList<Movie>> {
            override fun onResponse(
                call: Call<PagedMovieList<Movie>>,
                response: Response<PagedMovieList<Movie>>
